    ...
    return (
        <footer className="w-full font-sans text-zinc-900 bg-[#eff7f1] dark:bg-zinc-950">
            ...
            <div className={`${CONTAINER_CLASS} py-10 flex flex-col md:flex-row justify-between items-start md:items-center`}>
                <div className="w-full max-w-[550px] mb-8 md:mb-0">
                    <h3 className="text-xl font-onest font-extrabold tracking-wide text-[#1c4b31] dark:text-green-500 mb-3 uppercase">
                        Soyez informé des nouvelles
                    </h3>
                    <div className="flex w-full h-[50px] bg-[#357a55] dark:bg-green-900 overflow-hidden mb-2 font-sans">
                        <input
                            type="email"
                            placeholder="Entrez votre email"
                            className="bg-[#357a55] text-white placeholder-green-100 px-4 flex-1 outline-none text-xs"
                        />
                        <button className="w-[50px] h-[50px] shrink-0 bg-[#0b321a] hover:bg-black transition-colors flex items-center justify-center text-white" aria-label="S'inscrire">
                            <Image src="/icons/arrow-up-right.svg" alt="Subscribe" width={36} height={36} />
                        </button>
                    </div>
                    <p className="text-xs font-sans font-light tracking-wide text-nowrap">
                    ...
                    <div className="flex gap-3">
                        {SOCIAL_LINKS.map((social, i) => (
                            <a 
                                ...
                                className="w-[50px] h-[50px] rounded-full border border-[#4ea977] dark:border-green-500 flex items-center justify-center hover:bg-[#4ea977] hover:text-white transition-colors"
                            >
            ...
            <div className={`${CONTAINER_CLASS} py-12 flex flex-col lg:flex-row justify-between gap-12 lg:gap-24`}>
                ...
                <div className="flex flex-col items-start lg:w-1/4">
                    <div className="flex flex-col items-center w-[215px]">
                        ...
                        <button
                            onClick={scrollToTop}
                            className="w-[80px] h-[80px] shrink-0 rounded-full bg-[#357a55] hover:bg-[#1a4a30] transition-colors flex items-center justify-center text-white"
            ...
            <div className="bg-[#448b62] dark:bg-[#1a3826]">
                <div className={`${CONTAINER_CLASS} py-3.5 flex flex-col md:flex-row items-center justify-between text-white text-[11px] tracking-wide`}>
                    <p>© 2025 AEMP-Togo - Tous droits réservés.</p>
                    <p>Conçu et développé par PEREIRA Salim (DigiLab)</p>
                </div>
            </div>
        </footer>
    );
