...
export default function MobileNav({ links }: { links: NavLinkItem[] }) {
  ...
  return (
    <div className="md:hidden">
      ...
      {/* Le drawer est rendu dans un portail vers <body> pour ne pas être
          contenu par le header (qui applique backdrop-filter au scroll et
          deviendrait alors le bloc conteneur des enfants `fixed`). */}
      {mounted &&
        open &&
        createPortal(
